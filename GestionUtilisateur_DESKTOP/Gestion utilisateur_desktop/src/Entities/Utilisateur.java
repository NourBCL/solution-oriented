...
/*
    ...
    public Utilisateur(int id, String email, String roles, String password, String date_naissance, int num_tel, String image, String nom, String prenom, int is_verified) {
        this.id = id;
        this.email = email;
        this.roles = roles;
        this.password = password;
