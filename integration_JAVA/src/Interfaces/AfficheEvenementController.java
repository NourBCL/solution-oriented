...
public class AfficheEvenementController implements Initializable {
     ...
     public void refreshList()
    {
        ...
        for(evenement e : evenement){
           ...
           loader.setLocation(getClass().getResource("/Interfaces/ItemEv.fxml"));
           Parent root;
            try {
                root = loader.load();
    ...
    private void addEvenements(ActionEvent event){
        ...
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/Interfaces/ajouterEvenement.fxml"));
    ...
    @FXML
     private void openStat(ActionEvent event) {
                  try {
        Parent root = FXMLLoader.load(getClass().getResource("/Interfaces/statistique.fxml"));
        vItem.getScene().setRoot(root);
        } catch (IOException ex) {
            System.err.println(ex.getMessage());
        }
