...
public class AfficherDetailTransportController implements Initializable {
 ...
 DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
    ...
    private void adtra(ActionEvent event) {
        CommandeT t = new CommandeT((Date) TransportFrontController.connectedTransport.getDate_dep(),TransportFrontController.connectedTransport.getLieu_depart());
